...
# Коэффициент Adjusted R-squared: 0.009261 - коеффициент R^2 очень низкий 0.9% < 30%
...
# Коэффициент Adjusted R-squared: 0.1552 - коэффициент R^2, 
...
# Связь положительная т.к. k = 0.097 > 0
